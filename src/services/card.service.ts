...
// Kolon GECIS kurallari: bir karti hedef kolona tasimadan once kontrol
// eder. Kolonun kendi kurallari (transitionMode + 4 bayrak) kapaliysa
// (OFF) hicbir sorgu atmadan hemen donuyor - serbest gecis varsayilan
// davranis, ekstra sorgu maliyeti sadece kural acikken var.
async function checkColumnTransitionRules(
  cardId: string,
  destColumn: {
